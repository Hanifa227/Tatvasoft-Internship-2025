...
export class MissionService {
  ...
  missionDetailById(id: number) {
    return this.http.get(`https://localhost:7063/api/Mission/MissionDetailsById/${id}`);
  }
  ...
  updateMission(payload: any) {
    return this.http.post(`${this.apiUrl}/Mission/UpdateMission`, payload); // ✅ correct
  }
  ...
  return this.http.post(`${this.apiUrl}/Mission/MissionApplicationDelete`, id);
}
