...
//   id: 0,                // <- Assign 0 initially, will be set properly later
//   userId: 0,           // <- Same value as `id`, will assign both in ngOnInit
//   oldPassword: '',
//   newPassword: '',
//   confirmPassword: ''
// };
...
//   //        this.changePass.id = user.userId;
...
//   console.log('📤 ChangePassword Request Payload:', value); // Debug log

//   if (changePasswordForm.valid) {
//     const changePasswordSubscribe = this._loginService.changePassword(value).subscribe(
//       (data: any) => {
//         console.log('✅ ChangePassword Response:', data); // Debug log
...
//           this._toast.error({
//             detail: 'ERROR',
//             summary: data?.message || 'Password change failed.',
//             duration: APP_CONFIG.toastDuration,
//           });
//         }
//       },
...
//         this._toast.error({
//           detail: 'ERROR',
//           summary: err?.error?.message || 'Something went wrong while changing password.',
//           duration: APP_CONFIG.toastDuration,
//         });
//       }
//     );
...
//     this._toast.warning({
//       detail: 'WARNING',
//       summary: 'Please fill out all required fields correctly.',
//       duration: APP_CONFIG.toastDuration,
//     });
//   }
// }
